...
struct PolygonalMesh
{
    ...
    std::vector<std::vector<unsigned int>> Cell2DsVertices = {}; ///< Cell2D vertices indices, size 1 x NumberCell2D[NumberCell2D]
    std::vector<std::vector<unsigned int>> Cell2DsEdges = {}; ///< Cell2D edges indices, size 1 x NumberCell2D[NumberCell2D]
